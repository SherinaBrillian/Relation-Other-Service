...
public class Constant {
    public static final class Cart {
        ...
        public static final String GET_ALL = "SELECT c.cartUid, c.customerUid AS customerUid, c.productUid, c.priceUid, c.qty, c.serviceUid AS serviceUid, c.createdAt AS createdAt, c.updatedAt AS updatedAt, cu.customerUid AS customerUid, cu.userUid, cu.address, cu.pihkKbihu, cu.notes, cu.verifiedBy, cu.verifiedAt, cu.userImage, cu.verifyImage, cu.dirImage, cu.createdAt AS createdAt, cu.updatedAt, cu.createdBy AS updatedAt FROM tbCart c LEFT JOIN tbCustomer cu ON c.customerUid = cu.customerUid";
